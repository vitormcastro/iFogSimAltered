...
public class VmSchedulerSpaceSharedEnergy extends VmScheduler {
	...
	/*
	 * (non-Javadoc)
	 * @see main.java.org.cloudbus.cloudsim.VmScheduler#allocatePesForVm(main.java.org.cloudbus.cloudsim.Vm,
	 * java.util.List)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see main.java.org.cloudbus.cloudsim.VmScheduler#deallocatePesForVm(main.java.org.cloudbus.cloudsim.Vm)
	 */
	@Override
